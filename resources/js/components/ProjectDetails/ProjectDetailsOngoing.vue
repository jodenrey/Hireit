...
export default {
  ...
  computed: {
    ...
    expertiseIn () {
      let expertises = [
        { name: 'Digital Art', isRequired: this.project.DigitalArt },
        { name: 'Photography', isRequired: this.project.Photography },
        { name: 'Programming', isRequired: this.project.Programming },
        { name: 'Video Editing', isRequired: this.project.VideoEditing }
