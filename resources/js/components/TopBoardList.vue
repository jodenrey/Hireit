...
export default {
  ...
  data: () => ({
    expertise: 0,
    leader: [
      { icon: 'whh:painting', title: 'Digital Art' },
      { icon: 'bx:bx-code', title: 'Programming' },
      { icon: 'bx:bx-code-curly', title: 'Photography' },
      { icon: 'bx:bxs-data', title: 'Video Editing' }
    ],
  ...
  computed: {
    ...
    topBoards () {
      return [
        { data: this.DigitalArt },
        { data: this.data.Photography },
        { data: this.data.Programming },
        { data: this.data.VideoEditing }
      ]
    }
  },
