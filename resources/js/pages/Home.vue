  ...
  <div class="backwards">
    ...
    <!-- <div>
      ...
      <div class="slide-1__container">
       ...
       <!--   <div v-if="$matchMedia.xl" class="slide-1__ornament">
          ...
          <p class="slide-1__paragraph moveInTop duration--1_5">
            Earn money on the side while studying!
          </p>
      ...
      <div class="slide-1__image-container moveInTop duration--2">
         <!-- <img class="slide-1__dot-1" src="/images/dot-blue.svg" alt="">
          ...
          <img v-if="!$matchMedia.xl" class="slide-1__image" height="300" src="/images/sti.png" alt="">
          <img v-else class="slide-1__image" src="/images/sti.png" alt="">
        </div> 
      </div>
     <!--  <div>
    ...
    <div class="slide slide-2__container">
      <div v-if="$matchMedia.xl" class="slide-2__left">
        <img class="slide-2__image" src="/images/STI2.png" alt="">
      </div>
      <div class="slide-2__right">
        ...
        <p class="slide-2__paragraph">
          Know the available works that currently posted on the website and find your clients!
        </p>
    ...
    <div class="slide slide-3__container">
      ...
      <p class="slide-3__paragraph">
        These are the top freelancers in the website!
      </p>
...
export default {
  ...
  metaInfo () {
    return {
      title: 'Home',
      meta: [
        { name: 'description', content: 'Hireit: Freelancer Platform for Students.' }
      ]
    }
  },
