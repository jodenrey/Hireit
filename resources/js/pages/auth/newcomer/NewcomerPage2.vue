      ...
      <div class="">
        <div class="form-group__container">
          ...
          <template v-else-if="user.role === 'Lecturer'">
            <div class="">
              <input v-model="form.user.expertise" class="form-group__input-text mb-0_5" placeholder="e.g., Digital Art, Video Editing">
            </div>
          </template>
        </div>
              ...
              <template v-slot:body>
                <div>
                  ...
                  <div class="form-group__container">
                    ...
                    <div class="">
                      <input v-model="anotherExperience.name" class="form-group__input-text mb-0_5" placeholder="e.g., Hireit Developer">
                    </div>
                  </div>
                  <div class="form-group__container">
                    <h4 class="form-group__input-name post__h4">
                    ...
                    <div class="">
                      <input v-model="anotherExperience.role" class="form-group__input-text mb-0_5" placeholder="e.g., UI/UX Designer, Programmer">
                    </div>
                  </div>
                  <div class="form-group__container">
                    <h4 class="form-group__input-name post__h4">
