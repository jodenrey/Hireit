    ...
    <div class="resgiter-form--container">
      ...
      <form @submit.prevent="register" @keydown="form.onKeydown($event)">
        ...
        <div class="form-group__container">
          ...
          <div class="">
            <input v-model="form.email" :class="{ 'is-invalid': form.errors.has('email') }" class="form-group__input-text" type="email" name="email" placeholder="e.g., example@sjdelmonte.sti.edu.ph" autocomplete="username" required>
            <p v-if="form.role === 'Student'" class="form-group__input-info form-input__info--email">
