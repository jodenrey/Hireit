      ...
      <div>
        <div class="login-input--container mb-5 flex-row justify-center">
          <div class="input-w-100-sm">
            <input v-model="form.email" :class="{ 'is-invalid': form.errors.has('email') }" class="forgot-password__input" type="email" name="email" placeholder="e.g., example@sjdelmonte.sti.edu.ph" autocomplete="username" required>
        ...
        <p class="forgot-password__further-information">
          For further information. Please kindly reach out to <a href="mailto:josephdennisreyes@gmail.com">hireit@gmail.com</a>
        </p>
      </div>
