        ...
        <div>
          ...
          <div class="social-media__edit--container">
            <div class="social-media__edit-input--container">
              <span class="iconify social-media__edit--icon" data-icon="ic:baseline-facebook" />
              <input v-model="form.user.facebook" type="url" class="social-media__input" :placeholder="`e.g., facebook.com/${firstName}`">
            </div>

            <div class="social-media__edit-input--container">
              <span class="iconify social-media__edit--icon" data-icon="mdi:instagram" />
              <input v-model="form.user.instagram" type="url" class="social-media__input" :placeholder="`e.g., instagram.com/${firstName}`">
            </div>

            <div class="social-media__edit-input--container">
              <span class="iconify social-media__edit--icon" data-icon="mdi:twitter" />
              <input v-model="form.user.twitter" type="url" class="social-media__input" :placeholder="`e.g., twitter.com/${firstName}`">
            </div>
